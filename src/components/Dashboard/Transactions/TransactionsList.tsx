...
const TransactionsList: React.FC<TransactionsListProps> = ({
  ...
  return (
    <>
      ...
      <div className="self-stretch px-4 py-3 justify-start items-center gap-8 flex mt-6">
      ...
      {/* transactions list */}
      <ul className="self-stretch h-[696px] flex-col justify-start items-start flex divide-y divide-grey-100">
