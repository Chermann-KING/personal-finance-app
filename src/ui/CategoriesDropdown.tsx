...
const CategoriesDropdown: React.FC<CategoryDropdownProps> = ({
  ...
  return (
    <div className="relative w-full min-w-56" ref={dropdownRef}>
      ...
      <div
        role="listbox"
        className={`h-[300px] overflow-y-scroll scrollbar-thin no-scrollbar absolute right-0 w-full mt-2 rounded-lg shadow-custom bg-white z-10 divide-y divide-solid divide-grey-100 px-[19px] transform transition-all duration-300 ease-in-out ${
          isOpen
